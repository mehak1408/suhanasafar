  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.busWrap}>
        ...
        {/* Wheels */}
        <div style={{ ...styles.wheel, left: 22, animationDuration: "0.4s" }} />
        <div style={{ ...styles.wheel, left: 130, animationDuration: "0.4s" }} />
      </div>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.badges}>
          {["Real-time Tracking", "Seat Booking", "AI Assistant"].map((f) => (
